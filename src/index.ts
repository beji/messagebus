...
/**
 * this will be a uuid generated by the uuid npm package
 */
type MessageID = string;
type TopicID = string;
/**
 * could be a uuid generated by the uuid npm package or a hand chosen name
 */
...
export const subscribe = (
  ...
  const id = options && options.id ? options.id : uuid();
